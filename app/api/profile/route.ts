  ...
  try {
    ...
    const profile = await prisma.studentProfile.upsert({
      ...
      update: {
        ...
        enjoyedSubjects: JSON.stringify(data.enjoyedSubjects),
        dislikedSubjects: JSON.stringify(data.dislikedSubjects),
        ...
        careerInterests: JSON.stringify(data.careerInterests),
      },
      create: {
